    ...
    <div class="container">
      <?php
          ...
          <?php include ('connect.php');
                               $query = mysql_query("select * from jobs where job_id='$job_id'") or die(mysql_error());
                               $row = mysql_fetch_array($query);
              ?>

        <form method="post" action="jobcardgeneratereport.php"  enctype="multipart/form-data">
           <br>
                            ...
                            <br>
                                ...
                                <h3><font size="+3" color="blue"> Complete the form below </font></h3>
                                <br>
...
<?php include ('connect.php');
    ...
    ?>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="inputName">Job Attend By:</label>
                                            <input id="id_application_method_name" onchange="checkFilledname();" type="text" name="technician" minlength="4" maxlength="40" class="form-control" required="required" placeholder="Attend By" value="<?php echo $row['technician']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="pwd">Priority:</label>
                                            <input id="id_application_method_mobile" onchange="checkFilledmobile();" type="text" max="40" name="priority" class="form-control" required="required" placeholder="Priority" value="<?php echo $row['priority']; ?>">
                                        </div>
                                    </div>
                                </div>
                               <br>
                               <div class="row">
                                   <div class="col-md-6 col-sm-6">
                                       <div class="form-group">
                                           <label for="inputEmail">Customer Instructions:</label>
                                           <textarea style="width:500px; height:100px;" id="id_application_method_email" onchange="checkFilledemail();"  type="text" name="customer_instructions" minlength="4" maxlength="1000" class="form-control" required="required" placeholder="Customer Instructions" value="<?php echo $row['customer_instructions']; ?>"> </textarea>
                                       </textarea>
                                   </div>
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                       <div class="form-group">
                                           <label for="pwd">Work Carried Out:</label>
                                           <textarea style="width:500px; height:100px;" id="id_application_method_id" onchange="checkFilledid();" type="text" name="work_carried_out" minlength="4" maxlength="1000" class="form-control" required="required" placeholder="Work Carried Out" value="<?php echo $row['work_carried_out']; ?>"></textarea>
                                       </div>
                                   </div>
                               </div>
...
<?php include ('connect.php');
    ...
    ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="id_application_method_odo" onchange="checkFilledodo();"  type="date" name="start_date" class="form-control" required="required" placeholder="Start Date" value="<?php echo $row['start_date']; ?>">
                                    </div>
                                </div>
                               <div class="col-md-6 col-sm-6">
                                   <div class="form-group">
                           ...
                           <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                           <label for="pwd">Stop Date:</label>
                           <input id="id_application_method_mTyreRL" onchange="checkFilledmTyreRL();"  type="date" name="stop_date" class="form-control" required="required" placeholder="Stop Date" value="<?php echo $row['stop_date']; ?>">
                                    
    </div>
                               </div>
                           </div>
                          <input   type="hidden" name="company" class="form-control" required="required"  value="<?php echo $row['company']; ?>"
                          <br>
                         <input   type="hidden" name="job_id" class="form-control" required="required"  value="<?php echo $row['job_id']; ?>">
